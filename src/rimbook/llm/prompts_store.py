...
PROMPT_META: dict[str, dict[str, Any]] = {
    ...
    "volume_cast_system": {
        ...
        "zh_name": "本卷设定扩充 · 系统",
        "zh_module": "卷规划",
        "description": "卷规划 Step2：根据卷大纲扩充本卷出场设定与关系张力，尊重字段锁。",
        "placeholders": [],
        "in_use": True,
    },
    "volume_cast_user": {
        ...
        "zh_name": "本卷设定扩充 · 用户",
        "zh_module": "卷规划",
        "description": "注入卷大纲、已发生剧情、完整设定集摘要与已揭示设定索引。",
        "placeholders": [
            _ph("volume_title", "卷标题", "Step1 输出"),
            _ph("volume_arc", "卷弧线", "Step1 输出"),
            _ph("volume_ending", "卷收束", "Step1 输出"),
            _ph("story_context", "已发生剧情", "大纲近章回顾"),
            _ph("planning_brief", "完整设定集摘要", "planning_codex.render_brief()"),
