...
PROMPT_META: dict[str, dict[str, Any]] = {
    "synopsis_system": {
        ...
        "zh_name": "宏观梗概 · 系统（兼容）",
        "zh_module": "项目基础设定",
        "description": "兼容旧键：宏观梗概系统提示。新流程优先使用 foundation_synopsis_system。",
        "placeholders": [],
        "in_use": True,
    },
    "synopsis_user": {
        ...
        "zh_name": "宏观梗概 · 用户（兼容）",
        "zh_module": "项目基础设定",
        "description": "兼容旧键：宏观梗概用户消息。新流程优先使用 foundation_synopsis_user。",
        "placeholders": [_ph("premise", "用户提供的小说创意", "用户在「大纲」页输入")],
        "in_use": True,
    },
    "foundation_synopsis_system": {
        "stage": STAGE_PLANNING,
        "role": "system",
        "zh_name": "宏观梗概 · 系统",
        "zh_module": "项目基础设定",
        "description": "生成宏观全书梗概：主题/情感基调/叙事结构/核心冲突/主线/结局，不展开设定百科。",
        "placeholders": [],
        "in_use": True,
    },
    "foundation_synopsis_user": {
        "stage": STAGE_PLANNING,
        "role": "user",
        "zh_name": "宏观梗概 · 用户",
        "zh_module": "项目基础设定",
        "description": "把用户创意交给 LLM，要求只写宏观梗概。",
        "placeholders": [_ph("premise", "用户提供的小说创意", "用户在「大纲」页输入")],
        "in_use": True,
    },
    "foundation_codex_system": {
        "stage": STAGE_PLANNING,
        "role": "system",
        "zh_name": "完整设定集初始化 · 系统",
        "zh_module": "项目基础设定",
        "description": "根据创意与宏观梗概初始化六类当前已存在的完整设定集条目及关系。",
        "placeholders": [],
        "in_use": True,
    },
    "foundation_codex_user": {
        "stage": STAGE_PLANNING,
        "role": "user",
        "zh_name": "完整设定集初始化 · 用户",
        "zh_module": "项目基础设定",
        "description": "注入创意、宏观梗概与已有设定索引，要求输出 entries/relationships JSON。",
        "placeholders": [
            _ph("premise", "用户创意", "用户输入"),
            _ph("synopsis", "刚生成的宏观梗概", "outline.read_synopsis()"),
            _ph("existing_index", "已有完整设定集索引", "planning_codex.render_index()"),
            _ph("occupied_names", "已占用姓名清单", "planning_codex.occupied_names_block()"),
        ],
        "in_use": True,
    },
    "foundation_relabel_system": {
        "stage": STAGE_PLANNING,
        "role": "system",
        "zh_name": "设定必填字段补全 · 系统",
        "zh_module": "项目基础设定",
        "description": "对 foundation/volume_cast 漏填的 type 等必填字段做一次性批量打标。",
        "placeholders": [],
        "in_use": True,
    },
    "foundation_relabel_user": {
        "stage": STAGE_PLANNING,
        "role": "user",
        "zh_name": "设定必填字段补全 · 用户",
        "zh_module": "项目基础设定",
        "description": "注入宏观梗概与待补全条目列表，要求只补全缺失字段。",
        "placeholders": [
            _ph("synopsis", "宏观梗概", "outline.read_synopsis()"),
            _ph("incomplete_entries", "待补全条目 JSON", "partition_raw_entries"),
        ],
        "in_use": True,
    },
    "volume_cast_system": {
        ...
        "zh_name": "本卷设定扩充 · 系统",
        "zh_module": "卷规划",
        "description": "卷规划 Step3：根据详尽卷大纲扩充本卷出场设定与关系张力，尊重字段锁。",
        "placeholders": [],
        "in_use": True,
    },
    "volume_cast_user": {
        ...
        "zh_name": "本卷设定扩充 · 用户",
        "zh_module": "卷规划",
        "description": "注入卷大纲、写作框架出场约束、已发生剧情、设定集与已揭示索引；"
        "避免与已建组功能重叠。",
        "placeholders": [
            _ph("volume_title", "卷标题", "Step2 输出"),
            _ph("volume_arc", "卷弧线", "Step2 输出"),
            _ph("volume_ending", "卷收束", "Step2 输出"),
            _ph("framework_block", "本卷写作框架与出场约束", "volNN.framework.yaml"),
            _ph("story_context", "已发生剧情", "大纲近章回顾"),
            _ph("planning_brief", "完整设定集（涉及优先）", "planning_codex.render_entries_full()"),
            _ph("revealed_index", "已揭示设定集索引", "codex.iter_all()"),
            _ph("occupied_names", "已占用姓名清单", "planning_codex.occupied_names_block()"),
        ],
        "in_use": True,
    },
    "volume_framework_system": {
        "stage": STAGE_PLANNING,
        "role": "system",
        "zh_name": "写作框架 · 系统",
        "zh_module": "卷规划",
        "description": "卷规划 Step1：写作框架 + 详述出场/舞台；禁止输出卷大纲字段。",
        "placeholders": [],
        "in_use": True,
    },
    "volume_framework_user": {
        "stage": STAGE_PLANNING,
        "role": "user",
        "zh_name": "写作框架 · 用户",
        "zh_module": "卷规划",
        "description": "注入梗概、卷目、近章、线索、已揭示索引与完整设定集全文。",
        "placeholders": [
            _ph("synopsis", "全书梗概", "outline.read_synopsis()"),
            _ph("existing_desc", "已规划的卷目列表", "outline.list_volumes()"),
            _ph("prev_recap_block", "前卷已写章节回顾", "近8章"),
            _ph("open_threads_block", "未回收的情节线索", "threads"),
            _ph("revealed_index", "已揭示设定集索引", "codex"),
            _ph("planning_full_block", "完整设定集全文", "planning_codex.render_full()"),
            _ph("number", "本卷序号", "卷号"),
            _ph("title_hint", "可能的标题注脚", "卷标题"),
        ],
        "in_use": True,
    },
    "entity_sync_system": {
        ...
        "zh_name": "设定同步 · 系统",
        "zh_module": "完整设定集",
        "description": "手动/兼容路径：根据已发生剧情同步完整设定集。",
        "placeholders": [],
        "in_use": True,
    },
    "entity_sync_user": {
        ...
        "zh_name": "设定同步 · 用户",
        "zh_module": "完整设定集",
        "description": "注入设定网络与剧情上下文，要求输出变更 JSON。",
        "placeholders": [
            _ph("entity_network", "完整设定集摘要", "planning_codex.render_brief()"),
            _ph("story_context", "已发生剧情上下文", "大纲与近章"),
        ],
        "in_use": True,
    },
    **{
        f"codex_detail_{entry_type}_system": {
            "stage": STAGE_PLANNING,
            "role": "system",
            "zh_name": f"{label}详情细化 · 系统",
            "zh_module": "完整设定集详情",
            "description": f"按宏观到微观顺序生成{label}条目的长篇历史与底蕴。",
            "placeholders": [],
            "in_use": True,
        }
    ...
    "codex_detail_user": {
        ...
        "zh_name": "设定详情细化 · 用户",
        "zh_module": "完整设定集详情",
        "description": "注入宏观梗概、当前条目、世界观、上游与直接关联设定，输出 detail 与 details_patch。",
        "placeholders": [
            _ph("context", "当前条目及裁剪后的关联设定上下文", "planning_codex.render_detail_context()"),
        ],
        "in_use": True,
    },
    "world_expand_system": {
        "stage": STAGE_PLANNING,
        "role": "system",
        "zh_name": "真实世界扩展 · 候选挖掘系统",
        "zh_module": "完整设定集扩展",
        "description": "从已完成详情中克制识别值得独立建档的隐含存在，并输出证据、关系与相关度。",
        "placeholders": [],
        "in_use": True,
    },
    "world_expand_user": {
        "stage": STAGE_PLANNING,
        "role": "user",
        "zh_name": "真实世界扩展 · 候选挖掘用户",
        "zh_module": "完整设定集扩展",
        "description": "注入宏观梗概、已有索引、种子详情与剩余预算。",
        "placeholders": [
            _ph("synopsis", "宏观梗概", "outline.read_synopsis()"),
            _ph("existing_index", "完整设定集索引", "planning_codex.render_index()"),
            _ph("occupied_names", "已占用姓名清单", "planning_codex.occupied_names_block()"),
            _ph("seed_context", "本批种子详情", "WorldExpander 批量裁剪"),
            _ph("coefficient", "发散系数", "项目配置或请求"),
            _ph("depth", "当前扩展深度", "ExpansionRunState"),
            _ph("max_depth", "最大扩展深度", "ExpansionBudget"),
            _ph("max_candidates_per_seed", "每种子候选上限", "ExpansionBudget"),
            _ph("remaining_budget", "剩余新条目预算", "ExpansionRunState"),
        ],
        "in_use": True,
    },
    "volume_system": {
        ...
        "zh_name": "卷大纲 · 系统",
        "zh_module": "卷大纲",
        "description": "卷规划 Step2：在写作框架约束下产出详尽卷大纲 JSON"
        "（title/arc/ending/chapter_count），arc 建议 800-1500 字。",
        "placeholders": [],
        "in_use": True,
    },
    "volume_user": {
        ...
        "zh_name": "卷大纲 · 用户",
        "zh_module": "卷大纲",
        "description": "注入梗概、卷目、近章、写作框架、涉及实体全量设定与未回收线索。",
        "placeholders": [
            _ph("synopsis", "全书梗概", "outline.read_synopsis()"),
            ...
            _ph("framework_block", "本卷写作框架全文", "volNN.framework.yaml 格式化"),
            _ph("involved_entities_full", "涉及实体全量设定", "planning_codex.render_entries_full()"),
...
def render_preview(
    ...
    *,
    ...
    kwargs: dict[str, Any] = {
        ...
        "framework_block": "（占位示例：本卷写作框架与详述出场）\n\n",
        "involved_entities_full": "（占位示例：本卷涉及实体全量设定）\n\n",
        "planning_full_block": "（占位示例：完整设定集全文）\n\n",
        "revealed_index": "（占位示例：已揭示设定集索引）",
        "planning_brief": "（占位示例：完整设定集）",
        "story_context": "（占位示例：已发生剧情）",
        "occupied_names": "（占位示例：已占用姓名）",
